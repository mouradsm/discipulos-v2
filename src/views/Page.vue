      ...
      <main class="flex-1">        
        <div class="py-6">
          <div class="px-4 mx-auto max-w-7xl sm:px-6 md:px-8">
            <h1 class="text-2xl font-semibold text-gray-900">{{ $router.currentRoute.value.path === '/' ? 'Dashboard' : $router.currentRoute.value.name }}</h1>
          </div>
          <div class="px-4 mx-auto max-w-7xl sm:px-6 md:px-8">
...
const navigation = [
  ...
  { name: 'Vinculos', href: '/vinculos', icon: FolderIcon, current: false },
